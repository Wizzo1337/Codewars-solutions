...
console.log(newAvg([14, 30, 5, 7, 9, 11, 15], 92), 'Should return: ' + 645);
console.log(newAvg([14, 30, 5, 7, 9, 11, 15], 2), 'Should return: Expected New Average is too low');
console.log(newAvg([14, 30, 5, 7, 9, 11, 15], 90), 'Should return: ' + 628);
